...
@section('content')
    <div class="container mx-auto py-10">
        <div class="flex justify-start gap-4 items-center">
            <h1 class="text-3xl text-start font-bold">Departments</h1>
            <a href="{{ route('departments.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
                Add New Department
            </a>
        </div>
        ...
        <!-- Row Search Input -->
        <div class="my-4">
            <input type="text" id="rowSearch" placeholder="Search departments..." 
