                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #fff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
                    <tr>
                        <td style="padding: 0 30px 20px 30px; color: #555; font-size: 16px; line-height: 1.6; margin-top: 10px">
                            <p>
                                <br><br>
                                Hi,<br><br>
                                As per the vetted documents submitted for final approval, the reimbursement request for <strong>{{ $monthYear }}</strong>, has been approved. The Finance team can proceed with the release of payments as per the scheduled reimbursement process date.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="text-align: center; padding: 20px;">
                             <a href="{{ url('/travel/reimbursements/finance') }}"
