...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-2xl font-bold mb-6">Approved Employee Resignations</h1>

    @if($resignations->isEmpty())
    <p>No resignations with last working day assigned yet.</p>
    @else
    <table id="export-table" class="min-w-full bg-white">
        <thead>
            <tr>
                <th class="px-4 py-2">Employee ID</th>
                <th class="px-4 py-2">Employee Email</th>
                <th class="px-4 py-2">Employee Name</th>
                <th class="px-4 py-2">Employee Designation</th>
                <th class="px-4 py-2">Employee Department</th>
                <th class="px-4 py-2">Employee Date of Joining</th>
                <th class="px-4 py-2">Manager Name</th>
                <th class="px-4 py-2">Status</th>
                <th class="px-4 py-2">Reason</th>
                <th class="px-4 py-2">Resignation Date</th>
                <th class="px-4 py-2">Last Working Day</th>
        ...
        <tbody>
            ...
            <tr>
                <td class="border px-4 py-2">{{ $resignation->employee->employee_id }}</td>
                <td class="border px-4 py-2">{{ $resignation->employee->employee_email }}</td>
                <td class="border px-4 py-2">{{ $resignation->employee->employee_name }}</td>
                <td class="border px-4 py-2">{{ $resignation->employee->employee_designation }}</td>
                <td class="border px-4 py-2">{{ $resignation->employee->employee_department }}</td>
                <td class="border px-4 py-2">{{ $resignation->employee->employee_date_of_joining }}</td>
                <td class="border px-4 py-2">{{ $resignation->employee->manager->manager_name }}</td>
                <td class="border px-4 py-2">{{ $resignation->status }}</td>
                <td class="border px-4 py-2">{{ $resignation->reason }}</td>
                <td class="border px-4 py-2">{{ $resignation->resignation_date }}</td>
                <td class="border px-4 py-2">{{ $resignation->manager_last_working_day }}</td>
                <td class="border px-4 py-2">
                    <a href="{{ route('resignations.interview.process', $resignation->id) }}" class="flex items-center gap-2 text-white bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
