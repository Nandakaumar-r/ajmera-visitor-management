...
@section('content')
    <div class="container mx-auto py-10">
        ...
        <form action="{{ route('departments.update', $department) }}" method="POST" class="max-w-lg">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <textarea name="description" id="description" rows="4"
                          class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('description', $department->description) }}</textarea>
            </div>
