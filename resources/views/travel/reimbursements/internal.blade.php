            ...
            <table style="width: 100%; border-collapse: collapse; table-layout: auto; text-align: center;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @php
                            $day = now()->day;
                            $disableView = ($day > 19 && $reimbursement->status === 'manager_approved');
                        @endphp
                        <td style="border: 1px solid #dee2e6; padding: 0.75rem;">
                            @if ($disableView)
                                <span style="font-size: 0.875rem; padding: 0.25rem 0.5rem; background-color: #6c757d; color: white; border: none; border-radius: 0.2rem;">View</span>
                            @else
