                    ...
                    <tr>
                        <td style="padding: 0 30px 20px 30px; color: #555; font-size: 16px; line-height: 1.6;">
                            <p>
                                ...
                                Hi,<br><br>
                                Greetings!<br><br>
                                The reimbursement claims for <strong>{{ \Carbon\Carbon::now()->format('F Y') }}</strong>, concerning IT external employees, have been updated and are now available for your review and approval on the portal. Your prompt approval will allow us to proceed with the next stage of processing.
                            </p>
                        </td>
                    </tr>
