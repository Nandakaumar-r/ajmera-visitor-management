                    ...
                    <tr>
                        <td style="padding: 0 30px 20px 30px; color: #555; font-size: 16px; line-height: 1.6; margin-top: 10px">
                            <p>
                                ...
                                We’re pleased to inform you that the reimbursement claims for IT external employees for the month of <strong>{{ $month }}</strong>, have been successfully processed. The approved amounts will be credited to the respective employee accounts shortly.
                            </p>
