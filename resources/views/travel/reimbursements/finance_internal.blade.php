...
<div style="padding-top: 1.5rem; padding-bottom: 1.5rem; margin-top: 70px;">
    ...
    <form method="POST" action="{{ route('internal-reimbursements.bulk-approve') }}">
        ...
        <div style="overflow-x: auto;">
            ...
            @endphp
            @if (Request::is('travel/reimbursements/finance'))
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #dee2e6; padding: 0.75rem;">
                            @if(!in_array($reimbursement->status, ['processed', 'rejected']))
                        ...
                        @endphp
                        <td style="border: 1px solid #dee2e6; padding: 0.75rem;">{{ $currency }} {{ number_format($reimbursement->amount, 2) }}</td>
