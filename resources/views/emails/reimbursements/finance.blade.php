                    ...
                    <tr>
                        <td style="padding: 0 30px 20px 30px; color: #555; font-size: 16px; line-height: 1.6; margin-top: 10px">
                            <p>
                                <br><br>
                                Hi,<br><br>
                                The <strong>{{ $month }}</strong>, claims for IT external employees have been thoroughly reviewed and approved by the CFO. You may proceed with the necessary processing steps. Should you require any clarification, please feel free to reach out to the Reimbursement Team. Otherwise, kindly treat the claims as ready for disbursement
                            </p>
                        </td>
                    </tr>
