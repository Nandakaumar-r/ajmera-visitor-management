                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #fff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding: 0 30px 20px 30px; color: #555; font-size: 16px; line-height: 1.6; margin-top: 10px">
                            <p>
                                <br><br>
                                Hi,<br><br>
                                The reimbursement claims for IT Internal employees for the month of <strong>{{ $monthYear }}</strong>, have been duly reviewed and approved by the HR and verified the same from finance end also, and everything appears to be in order.
                            </p>
                            <p>
                    ...
                    <tr>
                        <td style="text-align: center; padding: 20px;">
                             <a href="{{ url('/travel/reimbursements/cfo') }}"
