                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #dee2e6; padding: 0.75rem;">
                            @if(!in_array($reimbursement->status, ['processed', 'rejected', 'cfo_approved', 'hold']))
                        ...
                        <td style="border: 1px solid #dee2e6; padding: 0.75rem;">
                            <a href="{{ route('accountant.reimbursement.action', $reimbursement->id) }}" style="font-size: 0.875rem; padding: 0.25rem 0.5rem; background-color: #198754; color: white; border: none; border-radius: 0.2rem; text-decoration: none;">View</a>
                        </td>
                    </tr>
                    @endforeach
